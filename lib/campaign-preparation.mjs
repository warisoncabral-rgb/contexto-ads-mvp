...
export const APPROVED_ROSA_VIP_CAMPAIGN_PRESET = Object.freeze({
  businessName: 'Rosa VIP',
  objective: 'leads',
  offer: 'Calçados femininos Rosa VIP no atacado, com pedido mínimo de R$ 500, mix de sapatilhas e mules, rasteirinhas, papetes e salto bloco, em modelos, cores e numerações de pronta entrega. Frete grátis e pagamento na entrega somente nas rotas programadas.',
  audience: 'Sacoleiros, pequenos revendedores, lojistas iniciantes, pessoas que já revendem ou querem começar e buscam fornecedor de calçados femininos com qualidade.',
  destination: 'whatsapp',
  geography: 'Recife-PE e Natal-RN',
  budgetMode: 'daily',
  budgetAmount: '10,00',
  durationDays: '30',
})
